...
class TestIpAlloc(test_case.ApiServerTestCase):
    ...
    def test_ip_alloc_with_routed_vn(self):
        ...
        iip1_ip_addr = iip1_obj.get_instance_ip_address()
        self.assertEqual(iip1_ip_addr, u'22.2.2.2')
        ...
        iip2_ip_addr = iip2_obj.get_instance_ip_address()
        self.assertEqual(iip2_ip_addr, u'22.2.2.1')
